...
class DocumentOCRSystemV3:
    ...
    def process_document(self, pdf_path: str, output_file: str = "final_result.txt"):
        ...
        for page_idx in range(len(doc)):
            ...
            # Create a subfolder for each page (B_pageindex)
            ...
            for item in generated_images:
                ...
                info = {
                    ...
                    'detected_types': [eg.value for eg in engine],
...
if __name__ == "__main__":
    ...
    processor = DocumentOCRSystemV3(output_dir=r"C:\Users\HUAWEI\Desktop\dyysai\output\md")
